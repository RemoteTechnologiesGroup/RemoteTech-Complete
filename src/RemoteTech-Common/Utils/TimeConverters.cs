...
namespace RemoteTech.Common.Utils
{
    namespace RemoteTech.Common.Utils
    {
        ...
        internal abstract class TimeStringConverter
        {
            ...
            /// </summary>
            /// <param name="duration">
            ///     time string like "1d 2m 3s" or "500" (as seconds).
            ///     Possible suffixes: y,d,h,m and s
            /// </param>
            ...
            private static double CalcFromSecondsToSring(double time, StringBuilder appendTo, uint baseSeconds,
                string prefix)
            {
